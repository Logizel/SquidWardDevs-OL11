...
SECRET_KEY = "your-super-secret-cryptographic-key-change-this-later"
ALGORITHM = "HS256"
...
# Dependency to get DB session just for auth (avoids circular imports)
def get_auth_db():
    db = SessionLocal()
    try:
        yield db
...
def get_current_user(
    ...
    """Verifies the JWT and returns the User object from the database."""
